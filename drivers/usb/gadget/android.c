...
//pengjiang 2013.02.04 add for A3000 HQ00279140
...
#if 1//def HQ_USB_MANUFACTURER_NAME
#define MANUFACTURER_STRING "Lenovo^Inc."
#else
...
#if 1//def HQ_USB_PRODUCT_NAME
#define PRODUCT_STRING      "Lenovo^Device"
#else
#define PRODUCT_STRING      "MT65xx Android Phone"
#endif


#if 1//def HQ_USB_MS_VENDOR
#define USB_MS_VENDOR       "Lenovo"
#else
#define USB_MS_VENDOR 		"Linux"
#endif


#if 1//def HQ_USB_MS_PRODUCT
#define USB_MS_PRODUCT      "IdeaTab^A1000"
#else
...
//pengjiang end for A3000 HQ00279140
...
#define NLUN_STORAGE 1
    ...
    //huangyisong_add_20130217 start
